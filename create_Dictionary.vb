...
New ClueEntry With {.Word = "SYSTEM", .Clue = "Set of connected parts"}
        ...
        ElseIf Puzzle = "pWord" Then
            Dim Words As New List(Of ClueEntry) From {
                ...
                New ClueEntry With {.Word = "MALIBU", .Clue = "Beach city in California"},
                New ClueEntry With {.Word = "MONTANA", .Clue = "Big Sky Country"},
                New ClueEntry With {.Word = "NEVADA", .Clue = "Home of Las Vegas"},
                New ClueEntry With {.Word = "OREGON", .Clue = "State with a coastline"},
                New ClueEntry With {.Word = "UTAH", .Clue = "State with the Great Salt Lake"},
                New ClueEntry With {.Word = "ARIZONA", .Clue = "State with the Grand Canyon"},
                New ClueEntry With {.Word = "COLORADO", .Clue = "State with the Rocky Mountains"},
                New ClueEntry With {.Word = "WYOMING", .Clue = "State with Yellowstone National Park"},
                New ClueEntry With {.Word = "ALASKA", .Clue = "Largest state in the US"},
                New ClueEntry With {.Word = "HAWAII", .Clue = "State made up of islands"},
                New ClueEntry With {.Word = "ALABAMA", .Clue = "State known for its southern hospitality"},
                New ClueEntry With {.Word = "ARKANSAS", .Clue = "State known for its natural beauty"},
                New ClueEntry With {.Word = "FLORIDA", .Clue = "State known for its beaches And theme parks"},
                New ClueEntry With {.Word = "GEORGIA", .Clue = "State known for its peaches And southern charm"},
                New ClueEntry With {.Word = "KENTUCKY", .Clue = "State known for its bourbon And horse racing"},
                New ClueEntry With {.Word = "LOUISIANA", .Clue = "State known for its Cajun culture And Mardi Gras"},
                New ClueEntry With {.Word = "MISSISSIPPI", .Clue = "State known for its river And blues music"},
                New ClueEntry With {.Word = "MEATHEADS", .Clue = "Bogans"},
                New ClueEntry With {.Word = "STOCKCLERK", .Clue = "Keeps track of Inventory"},
                New ClueEntry With {.Word = "BEERBELLY", .Clue = "DRINKING MAN'S PROBLEM"},
                New ClueEntry With {.Word = "BLOODLETTING", .Clue = "VENESECTION"},
                New ClueEntry With {.Word = "PILLOWFIGHT", .Clue = "BEDTIME GAME"},
                New ClueEntry With {.Word = "GUTTERBALL", .Clue = "TENPIN OOPSIE"},
                New ClueEntry With {.Word = "OURLADY", .Clue = "VIRGIN MARY"},
                New ClueEntry With {.Word = "SPRINGMELT", .Clue = "END OF WINTER SNOW"},
                New ClueEntry With {.Word = "EMUEGG", .Clue = "VERY LARGE OVUM"},
                New ClueEntry With {.Word = "HONKING", .Clue = "GOOSE CALL"},
                New ClueEntry With {.Word = "MENUINBLACK", .Clue = "EDDIE MURPHY WAS ONE"},
                New ClueEntry With {.Word = "MANITOU", .Clue = "DUGONG"},
                New ClueEntry With {.Word = "LORDSALEAPING", .Clue = "YOU GET THIS ON DECEMBER 12TH"},
                New ClueEntry With {.Word = "MERETRIFLE", .Clue = "Not WORTH WORRYING ABOUT"},
                New ClueEntry With {.Word = "SHORECOVER", .Clue = "PLANTS IN  SAND DUNES"},
                New ClueEntry With {.Word = "LYINGINWAIT", .Clue = "AMBUSH"},
                New ClueEntry With {.Word = "NOSWIMMING", .Clue = "WARNING SIGN"},
                New ClueEntry With {.Word = "ATATIME", .Clue = "TAKE YOUR TURN"},
                New ClueEntry With {.Word = "GOBBLE", .Clue = "TURKEY SONG"},
                New ClueEntry With {.Word = "SNAKEOIL", .Clue = "SOLD BY CHARLETINS"},
                New ClueEntry With {.Word = "CARPEDIEM", .Clue = "SEIZE THE DAY"},
                New ClueEntry With {.Word = "BELLEBOTTOMS", .Clue = "ONCE FASHIONABLE TROUSERS"},
                New ClueEntry With {.Word = "HANGOVER", .Clue = "THE COST OF A GOOD NIGHT OUT"},
                New ClueEntry With {.Word = "POPSTHECORK", .Clue = "OPENS THE BOTTLE"},
                New ClueEntry With {.Word = "UNSWAYED", .Clue = "STEADFAST"},
                New ClueEntry With {.Word = "SNOWCLAD", .Clue = "WINTER MOUNTAIN"},
                New ClueEntry With {.Word = "TOUCHESDOWN", .Clue = "LANDS"},
                New ClueEntry With {.Word = "JOBGUARANTEE", .Clue = "AT THE END OF A INTERNSHIP"},
                New ClueEntry With {.Word = "THELOONIE", .Clue = "CRAZY PERSON"},
                New ClueEntry With {.Word = "BASEVALUE", .Clue = "STARTING POINT"},
                New ClueEntry With {.Word = "WADINGIN", .Clue = "START WITH ENTHUSIASM"},
                New ClueEntry With {.Word = "MAGICSHOPS", .Clue = "CHILDS FAVORITE SHOP"},
                New ClueEntry With {.Word = "VENTPIPE", .Clue = "GAS DUCT"},
                New ClueEntry With {.Word = "FLEABAG", .Clue = "DIRTY DOG"},
                New ClueEntry With {.Word = "SUBLEVEL", .Clue = "BASEMENT"},
                New ClueEntry With {.Word = "PUPTRAILER", .Clue = "SMALL DOG TRANSPORT"},
                New ClueEntry With {.Word = "DERBYHATS", .Clue = "Type OF HEADWEAR"},
                New ClueEntry With {.Word = "HEINZFIELD", .Clue = "SEINFIELD'S ALTER EGO"},
                New ClueEntry With {.Word = "WITCHINGWELL", .Clue = "WITCHES WATER SOURCE"},
                New ClueEntry With {.Word = "POPTHEQUESTION", .Clue = "PROPOSE"}
                            }
